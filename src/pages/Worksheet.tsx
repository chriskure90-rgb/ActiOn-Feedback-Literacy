...
export default function Worksheet() {
  ...
  function buildPlanText(): string {
    ...
    if (setup.feedback.trim()) {
      lines.push("", "Feedback Received:", setup.feedback.trim());
    }
    lines.push(
      "",
      "MANAGING AFFECT",
  ...
  function handleDownload() {
    ...
    a.href = url;
    a.download = `feedback-plan-${setup.title.trim().replace(/\s+/g, "-").toLowerCase() || "worksheet"}.txt`;
    a.click();
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-5 py-10 md:py-14">
        ...
        {/* Generated plan */}
        {submitted && (
          <div ref={planRef} className="mt-2 mb-8">
            {/* Success banner + action buttons */}
            <div className="rounded-xl border border-teal/30 bg-teal-soft px-6 py-5 flex items-start gap-4 mb-6 flex-wrap">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-muted-foreground mt-0.5 leading-relaxed">
                  Your Feedback Action Plan is ready. Copy or download it to keep it alongside your
                  assignment.
                </p>
              </div>
              <div className="flex items-center gap-2 shrink-0 self-center">
                <button
                  onClick={handleCopy}
                  className="inline-flex items-center gap-1.5 text-xs font-bold text-teal border border-teal/30 bg-white rounded-md px-3 py-1.5 hover:bg-teal/5 active:scale-95 transition-all shadow-sm"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 text-xs font-bold text-primary border border-border bg-white rounded-md px-3 py-1.5 hover:bg-muted/50 active:scale-95 transition-all shadow-sm"
                >
            ...
            <div className="rounded-xl border border-border bg-white shadow-card-md overflow-hidden">
              ...
              <div className="bg-primary px-6 py-5">
                ...
                <p className="text-sm text-white/70 mt-1">{setup.title.trim()}</p>
              </div>

              {/* Feedback received (if entered) */}
              {setup.feedback.trim() && (
              ...
              {/* Plan footer */}
              <div className="bg-muted/40 border-t border-border px-6 py-4 flex items-center justify-between flex-wrap gap-2">
